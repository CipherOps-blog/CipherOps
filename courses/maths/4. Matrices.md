...
<span style="color:red">**Definition 4.1.**</span> A matrix A with n rows and p columns is a rectangular array of real (or complex) numbers, written A = (aᵢⱼ)₁≤ᵢ≤ₙ, ₁≤ⱼ≤ₚ, where aᵢⱼ denotes the entry in row i and column j. The dimension of the matrix is written n × p.
