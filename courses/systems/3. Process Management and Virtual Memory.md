...
### 1.2. The ELF Format and the Role of the Loader
...
### 1.3. Process Lifecycle and State Transitions
...
### 1.4. Zombie and Orphan Processes
...
### 1.5. Process Inspection via the /proc Filesystem
...
### 3.1. Multilevel Page Tables: Terminology in x64, ARM, and Linux
