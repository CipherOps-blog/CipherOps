# Historical and Architectural Foundations of Computing Systems

## 1. Theoretical Origins of Computation
...
#### 1.3.1 Case Study: Modeling Addition on a Turing Machine
...
## 2. From Abstract Models to Physical Machines
...
### 2.2. The Intel 4004 Microprocessor

The Intel 4004, released in 1971, is a 4-bit processor, meaning it operated on data in 4-bit words. Its components included a 4-bit arithmetic and logic unit responsible for basic calculations, approximately sixteen 4-bit registers used as working memory to retain the processor's state, and a microsequencer paired with microprogram logic responsible for fetching opcodes from read-only memory and coordinating their execution.
...
## 3. Contemporary Processor Architecture

Processor design has changed significantly since the introduction of the first commercial microprocessors. Comparing early and contemporary chips illustrates changes in die area, manufacturing process, clock speed, transistor count, and word size. 
...
The relationship between the rate of increase in transistors per chip and the rate of increase in chip surface area corresponds to the trend described as Moore's Law. He observed that the number of transistors on an integrated circuit tends to double at regular intervals. In his original paper, he projected a doubling approximately every year; in 1975, he revised this estimate to approximately every two years. The trend was not a physical law but an empirical observation based on semiconductor manufacturing progress, later used as a target by the semiconductor industry for planning production and research.
...
## 4. Privilege Levels and System Security
